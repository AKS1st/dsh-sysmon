...
function render(root: HTMLElement, info: SysInfo | null): void {
  ...
  root.replaceChildren(
    span('sm-group', span('sm-label', 'CPU '), span(LEVEL_CLASS[cpuLevel], cpu)),
    span('sm-group', span('sm-label', 'MEM '), span(LEVEL_CLASS[memLevel], mem)),
    span('sm-group', span('sm-label', 'DISK '), span(LEVEL_CLASS[diskLevel], disk)),
  )
}
