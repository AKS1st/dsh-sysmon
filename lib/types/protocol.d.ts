...
export declare const SYSINFO_ROUTE = "/dsh-sysmon/api";
 ...
 */
export declare function warnLevel(value: number): WarnLevel;
/**
 ...
 */
export declare function cpuWarnLevel(cpu: number, cores: number): WarnLevel;
